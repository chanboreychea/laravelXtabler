        ...
        <div class="container-xl">
            ...
            <div class="page-body">
                <div class="row row-cards ">
                    <form action="/confirmation-letters/update/{{ $confirmationLetter->id }}" method="POST"
                                    ...
                                    <div class="row g-3 mb-4">
                                        ...
                                        <div class="col-md-12 col-xl-3">
                                            ...
                                            <select name="type_of_letter" id="type_of_letter" class="form-select"
                                                ...
                                                <option value="{{ $confirmationLetter->type_of_letter }}" selected>
                                                    {{ $confirmationLetter->type_of_letter }}</option>
                                        ...
                                        <div class="col-md-12 col-xl-9">
                                            ...
                                            <input type="text" class="form-control" name="reference"
                                                value="{{ $confirmationLetter->reference }}" placeholder="យោង">
                                    ...
                                    <div class="row g-3 mb-4">
                                        <div class="col-md-12 col-xl-3">
                                            ...
                                            <input type="text" class="form-control" name="employee_name_kh"
                                                value="{{ $confirmationLetter->employee_name_kh }}"
                                            ...
                                            <div class="row g-2">
                                                <div class="col-4">
                                                    <input type="number" class="form-control"
                                                        value="{{ $confirmationLetter->day_of_birth }}" name="day_of_birth"
                                                ...
                                                <div class="col-4">
                                                    <input type="number" class="form-control" name="month_of_birth"
                                                        value="{{ $confirmationLetter->month_of_birth }}" placeholder="ខែ"
                                                        min="1" max="12">
                                                ...
                                                <div class="col-4">
                                                    <input type="number" class="form-control" name="year_of_birth"
                                                        value="{{ $confirmationLetter->year_of_birth }}"
                                                        placeholder="ឆ្នាំ" min="1900" max="{{ date('Y') }}">
                                                    @error('year_of_birth')
                                                        <div class="text-danger mt-2">
                                                            {{ $message }}
                                                        </div>
                                    ...
                                    <div class="row g-3 mb-4">
                                        <div class="col-md-12 col-xl-4">
                                            ...
                                            <input type="text" class="form-control" name="type_of_employee"
                                                value="{{ $confirmationLetter->type_of_employee }}"
                                                placeholder="ប្រភេទមន្ត្រី">
                                        ...
                                        <div class="col-md-12 col-xl-4">
                                            ...
                                            <input type="text" class="form-control"
                                                value="{{ $confirmationLetter->employee_position }}"
                                                name="employee_position" placeholder="តួនាទី">
                                        ...
                                        <div class="col-md-12 col-xl-4">
                                            ...
                                            <input type="text" class="form-control" name="department_name"
                                                value="{{ $confirmationLetter->department_name }}"
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-icon">
                                                <textarea type="text" cols="5" autocomplete="off" placeholder="គោលបំណង" class="form-control"
                                                    id="purpose" name="purpose">{{ $confirmationLetter->purpose }}</textarea>
                                            </div>
                                            @error('purpose')
                                                <div class="text-danger mt-2">
                                                    {{ $message }}
                                ...
                                <div class="modal-footer">
                                    <div class="d-flex justify-content-between gap-2">
                                        ...
                                        <button type="submit" class="btn btn-success">
                                            ...
                                            <span class="text">បច្ចុប្បន្នភាព</span>
                                        </button>
                                    </div>
                                </div>
